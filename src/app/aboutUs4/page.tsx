    ...
    <div className="container m-auto flex flex-col items-center justify-center gap-12 overflow-hidden px-10 py-4 tracking-[0.3px]">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-24">
          <div className="grid md:grid-cols-5 gap-12 items-center">
            <div className="md:col-span-2 group cursor-pointer">
              <div className="h-full w-full logo-reflection">
                <Image
                  src="/dxLogo.webp"
                  alt="Animation workspace"
                  className="w-full rounded-2xl logo-reflection"
                  height={500}
                  width={500}
                />
              </div>
            ...
            <div className="space-y-6 md:col-span-3">
              <span className="text-white text-sm font-medium uppercase tracking-[3px]">
                IT STARTED WITH -
              </span>
              <h1 className="text-2xl md:text-4xl lg:text-4xl font-bold text-white leading-tight italic">
      ...
      <div className="flex flex-col gap-6 text-center md:gap-12">
          ...
          <div className="w-full relative grid md:grid-cols-5">
            <div className="md:col-span-1 ">
              <div className="absolute top-2 left-[120px]  bg-black bg-opacity-50">
                <p className="font-light tracking-[5px] text-7xl uppercase text-start">
                  Bringing <br></br>imagination<br></br> to life.
                </p>
              </div>
            </div>
        ...
        <div className="flex w-full flex-col gap-4 text-sm">
          ...
          <p className="text-start text-sm font-light tracking-[5px]">Owner</p>
